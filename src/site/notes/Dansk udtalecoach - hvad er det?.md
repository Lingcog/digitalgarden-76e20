...
Appen giver pt. instrukser på albansk, arabisk, dansk, engelsk, farsi, fransk, italiensk, kinesisk, norsk, polsk, spansk, svensk, thai, tyrkisk, ukrainsk, urdu, vietnamesisk.
...
• Neural TTS: Jeg har integreret en moderne AI-stemme, så eleven kan høre forskel på f.eks. "hun" (uden stød) og "hund" (med stød).

4. Tale til Tekst (Fri diktat) - *klar!*
